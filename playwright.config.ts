...
export default defineConfig({
    ...
    projects: [
        ...
        { name: 'chrome-invalidLogin', testMatch: 'LoginDataDriven.spec.ts', use: { ...devices['Desktop Chrome'] }, dependencies: ['chrome-registration'] },
        { name: 'chrome-validLogin', testMatch: 'LoginValidCredentials.spec.ts', use: { ...devices['Desktop Chrome'] }, dependencies: ['chrome-registration'] },
        { name: 'chrome-addProductTowishlist', testMatch: 'AddProductToWishList.spec.ts', use: { ...devices['Desktop Chrome'] }, dependencies: ['chrome-invalidLogin'] },
        ...
        { name: 'firefox-invalidLogin', testMatch: 'LoginDataDriven.spec.ts', use: { ...devices['Desktop Firefox'], actionTimeout: 12000 }, dependencies: ['firefox-registration'] },
        { name: 'firefox-validLogin', testMatch: 'LoginValidCredentials.spec.ts', use: { ...devices['Desktop Firefox'], actionTimeout: 12000 }, dependencies: ['firefox-registration'] },
        { name: 'firefox-addProductTowishlist', testMatch: 'AddProductToWishList.spec.ts', use: { ...devices['Desktop Firefox'], actionTimeout: 12000 }, dependencies: ['firefox-invalidLogin'] },
        ...
        { name: 'webkit-validLogin', testMatch: 'LoginValidCredentials.spec.ts', use: { ...devices['Desktop Safari'], actionTimeout: 30000 }, dependencies: ['webkit-registration'] },
        { name: 'webkit-addProductTowishlist', testMatch: 'AddProductToWishList.spec.ts', use: { ...devices['Desktop Safari'], actionTimeout: 30000 }, dependencies: ['webkit-invalidLogin'] },
